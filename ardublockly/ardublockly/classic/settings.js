...
window.addEventListener('load', function() {
  ...
  ArdublocklyServer.requestExamplesLocation(
      ArduinoSettings.setExamplesLocationHtml);
  ...
  ArduinoSettings.bindClick_('settings_examples_location', function() {
    ArdublocklyServer.requestExamplesLocation(
        ArduinoSettings.setExamplesLocationHtml);
  });
...
/**
 * Sets the examples location form data retrieve from an updated element.
 * @param {element} jsonResponse JSON data coming back from the server.
 */
ArduinoSettings.setExamplesLocationHtml = function(jsonResponse) {
  if (jsonResponse != null) {
    var newEl = ArdublocklyServer.createElementFromJson(jsonResponse);
    var examplesLocIp = document.getElementById('settings_examples_location');
    if (examplesLocIp != null) {
      examplesLocIp.value = newEl.value;
    }
  }
};
