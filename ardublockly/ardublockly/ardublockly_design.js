...
/**
 * Resize the button to toggle the toolbox visibility to the width of the
 * toolbox.
 ...
 * @return {HTMLDivElement} HTML element to display the category content.
 */
Ardublockly.createExtraBlocksCatHtml = function (title, description, clickBind) {
    ...
    descriptionHtml.appendChild(document.createTextNode(description));
    ...
    htmlContent.appendChild(descriptionHtml);
    return htmlContent;
};
...
Ardublockly.arduinoIdeOutput = function (bodyEl) {
    ...
    ideOutputContent.innerHTML = '';
    ideOutputContent.appendChild(bodyEl);
 ...
 */
Ardublockly.resetIdeOutputContent = function () {
    var ideOutputContent = document.getElementById('content_ide_output');
...
Ardublockly.highlightIdeOutputHeader = function (body) {
