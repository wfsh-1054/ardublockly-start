...
Blockly.Blocks['char'] = {
    ...
    newQuote_: function (open) {
        if (open == this.RTL) {
            var file = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAYAAAAKCAYAAACXDi8zAAAACXBIWXMAAC4jAAAuIwF4pT92AAAAZUlEQVR42mNgAIL////7AHEJEIcAMSMDVBDEQQZTYRJt/zGBAEgiE4uEBkiCEYgTgHg2ED+GSmgyIAOgwG2oBCeyoCQQ/wXibmRBQajK70DMBhMsA+JfQPwSiLmQVXcBcTkDGgAAYj6aljihuoYAAAAASUVORK5CYII=';
        } else {
            var file = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAYAAAAKCAYAAACXDi8zAAAACXBIWXMAAC4jAAAuIwF4pT92AAAAXklEQVR42mNgQAL///8XA+KtQOyOLKj5HwLeA7EZTFAFKniOAc2IT0D8EYiZkAW9oKrD0FUXQSVWAvE0ILaESRT8xwQKIAk/LBLOIAlGLBKCMON4gTgDiEuAWBEkBgDRwppuX2Kh2gAAAABJRU5ErkJggg==';
        }
        return new Blockly.FieldImage(file, 6, 12, '"');
    },
    /** @return {!character} Type of the block, text block always a character. */
...
Blockly.Blocks['text_prompt_ext'] = {
    ...
    init: function () {
        var TYPES =
            [[Blockly.Msg.TEXT_PROMPT_TYPE_TEXT, Blockly.Types.STRING.output],
        ...
        this.setOutput(true, Blockly.Types.STRING.output);
        this.setTooltip(function () {
            return (thisBlock.getFieldValue('TYPE') == Blockly.Types.STRING.output) ?
    ...
    updateType_: function (newOp) {
        this.outputConnection.setCheck(newOp == Blockly.Types.NUMBER.output ?
            Blockly.Types.NUMBER.checkList : Blockly.Types.STRING.checkList);
    },
    /**
    ...
    getBlockType: function () {
        return (this.getFieldValue('TYPE') == Blockly.Types.STRING.output) ?
            Blockly.Types.STRING : Blockly.Types.NUMBER;
    }
};
...
Blockly.Blocks['text_prompt'] = {
    ...
    getBlockType: function () {
        return (this.getFieldValue('TYPE') == Blockly.Types.NUMBER.output) ?
            Blockly.Types.NUMBER : Blockly.Types.STRING;
    }
};

Blockly.Blocks['string_hex'] = {
    init: function () {
        this.setColour(Blockly.Blocks.texts.HUE);
        this.appendValueInput("CONTENT", Number);
        this.appendDummyInput()
            .appendField(Blockly.Msg.TEXT_TO_HEX)
            .appendField(new Blockly.FieldDropdown([
                [Blockly.Msg.TEXT_HEX, "HEX"],
                [Blockly.Msg.TEXT_BIN, "BIN"],
                [Blockly.Msg.TEXT_DEC, "DEC"]
            ]), "STAT")
            .appendField(Blockly.Msg.VARIABLES_TYPE_STRING);
        this.setOutput(true, null);
        this.setInputsInline(true);
        this.setTooltip(Blockly.Msg.TEXT_TO_HEX_TOOLTIP);
    },
    /** Assigns a type to the block, prompt always returns a string. */
    getBlockType: function () {
        return Blockly.Types.STRING;
