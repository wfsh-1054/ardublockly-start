...
Blockly.Msg.CONTROLS_SWITCH = "判斷 ";
Blockly.Msg.CONTROLS_SWITCH_BREAK = "中斷";
Blockly.Msg.CONTROLS_SWITCH_BREAK_TOOLTIP = "中斷並離開switch積木";
Blockly.Msg.CONTROLS_SWITCH_CASE = "條件";
Blockly.Msg.CONTROLS_SWITCH_DEFAULT = "如果沒有對應的值";
...
Blockly.Msg.LISTS_GET_INDEX_FROM_START = "第#筆";  // untranslated
...
Blockly.Msg.ARD_ANALOGWRITE = "類比輸出 PWM腳位#";
Blockly.Msg.ARD_ANALOGWRITE_TIP = "輸出類比值 0 到 255 到指定 PWM 腳位";
Blockly.Msg.ARD_BUILTIN_LED = "數位輸出 內建LED ";
Blockly.Msg.ARD_BUILTIN_LED_TIP = "點亮或熄滅Arduino開發板內建的 LED";
Blockly.Msg.ARD_COMPONENT_WARN1 = "一個 %1 設置積木與 %2 相同名稱必須新增後才能使用此積木!";
...
Blockly.Msg.ARD_PIN_WARN1 = "腳位 %1 是必須的對於腳位 %2 如同腳位 %3";
...
Blockly.Msg.ARD_SERIAL_PRINT = "顯示";
Blockly.Msg.ARD_SERIAL_PRINT_NEWLINE = "加上換行";
Blockly.Msg.ARD_SERIAL_PRINT_TIP = "顯示資料到 主控台/序列埠 這是可閱讀的 ASCII 字串";
Blockly.Msg.ARD_SERIAL_PRINT_WARN = "設定serial區塊 %1 一定需要新增到工作區後才能使用此積木!";
Blockly.Msg.ARD_SERIAL_SETUP = "設定";
Blockly.Msg.ARD_SERIAL_SETUP_TIP = "選擇特定序列埠的傳輸率";
Blockly.Msg.ARD_SERIAL_SPEED = "傳輸率 :";
Blockly.Msg.ARD_SERVO_READ = "讀取 伺服馬達 腳位#";
Blockly.Msg.ARD_SERVO_READ_TIP = "讀取伺服馬達目前的角度";
Blockly.Msg.ARD_SERVO_WRITE = "設定 伺服馬達 腳位#";
...
Blockly.Msg.ARD_SPI_SETUP_CONF = "設置:";
Blockly.Msg.ARD_SPI_SETUP_DIVIDE = "通訊時脈";
...
Blockly.Msg.ARD_SPI_SETUP_SHIFT = "位元順序";
Blockly.Msg.ARD_SPI_SETUP_TIP = "設置 SPI 周邊";
Blockly.Msg.ARD_SPI_TRANSRETURN_TIP = "送出一個 SPI 訊息到特定的從端裝置, 和取得回傳資料";
Blockly.Msg.ARD_SPI_TRANS_NONE = "none";
Blockly.Msg.ARD_SPI_TRANS_SLAVE = "到從端腳位#";
Blockly.Msg.ARD_SPI_TRANS_TIP = "送出一個 SPI 訊息到特定的從端裝置";
Blockly.Msg.ARD_SPI_TRANS_VAL = "傳輸";
Blockly.Msg.ARD_SPI_TRANS_WARN1 = "設定SPI區塊 %1 一定需要新增到工作區後才能使用此積木!";
Blockly.Msg.ARD_SPI_TRANS_WARN2 = "舊腳位值 %1 已經不再可以使用";
Blockly.Msg.ARD_STEPPER_COMPONENT = "步進馬達";
Blockly.Msg.ARD_STEPPER_DEFAULT_NAME = "MyStepper";
Blockly.Msg.ARD_STEPPER_FOUR_PINS = "4";
Blockly.Msg.ARD_STEPPER_MOTOR = ":";
Blockly.Msg.ARD_STEPPER_NUMBER_OF_PINS = "腳位數";
...
Blockly.Msg.ARD_STEPPER_REVOLVS = "每一圈有幾步";
Blockly.Msg.ARD_STEPPER_SETUP = "設定 步進馬達";
Blockly.Msg.ARD_STEPPER_SETUP_TIP = "設定步進馬達腳位和其他設定";
Blockly.Msg.ARD_STEPPER_SPEED = "轉速(rpm)";
Blockly.Msg.ARD_STEPPER_STEP = "轉動 步進馬達";
Blockly.Msg.ARD_STEPPER_STEPS = "步";
Blockly.Msg.ARD_STEPPER_STEP_TIP = "旋轉步進馬達到設定的步數";
...
Blockly.Msg.ARD_TONE_TIP = "設定腳位產生頻率範圍 31 - 65535 的音調";
Blockly.Msg.ARD_TONE_WARNING = "頻率必須在範圍 31 - 65535";
...
Blockly.Msg.ARD_VAR_AS_TIP = "設定值為指定的型態";
Blockly.Msg.ARD_WRITE_TO = "為";
Blockly.Msg.NEW_INSTANCE = "新實例";
Blockly.Msg.NEW_INSTANCE_TITLE = "新實例名稱:";
Blockly.Msg.RENAME_INSTANCE = "重新命名實例";
Blockly.Msg.RENAME_INSTANCE_TITLE = "重新命名所有 '%1' 實例為:";
