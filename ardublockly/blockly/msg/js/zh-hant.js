...
Blockly.Msg.COLOUR_BLEND_HELPURL = "https://meyerweb.com/eric/tools/color-blend/";  // untranslated
...
Blockly.Msg.COLOUR_RGB_HELPURL = "https://www.december.com/html/spec/colorper.html";  // untranslated
...
Blockly.Msg.CONTROLS_REPEAT_TIME_LOOP = "重複 %1 秒";
...
Blockly.Msg.CONTROLS_SWITCH_BREAK_TOOLTIP = "中斷並離開switch積木";
Blockly.Msg.CONTROLS_SWITCH_BREAK_WARNING = "警告: 此積木必須在switch內";
Blockly.Msg.CONTROLS_SWITCH_CASE = "case";
Blockly.Msg.CONTROLS_SWITCH_CASE_TOOLTIP = "增加條件";
Blockly.Msg.CONTROLS_SWITCH_DEFAULT = "default";
Blockly.Msg.CONTROLS_SWITCH_DEFAULT_TOOLTIP = "一個switch只會有一個default";
Blockly.Msg.CONTROLS_SWITCH_DO = "執行";
Blockly.Msg.CONTROLS_SWITCH_TOOLTIP_1 = "如果符合第一個條件，執行第一個語句";
Blockly.Msg.CONTROLS_SWITCH_TOOLTIP_2 = "如果符合第一個條件，執行第一個語句；如果都沒有符合，執行Default語句";
Blockly.Msg.CONTROLS_SWITCH_TOOLTIP_3 = "如果符合第一個條件，執行第一個語句；如果符合第二個條件，執行第二個語句；...";
Blockly.Msg.CONTROLS_SWITCH_TOOLTIP_4 = "如果符合第一個條件，執行第一個語句；如果符合第二個條件，執行第二個語句；...,；如果都沒有符合，執行Default語句";
Blockly.Msg.CONTROLS_TIME_LOOP = "重複";
Blockly.Msg.CONTROLS_TIME_SEC = "秒";
...
Blockly.Msg.COPY_ALL_BLOCK = "複製積木串";
Blockly.Msg.COPY_BLOCK = "複製";
...
Blockly.Msg.LISTS_GET_INDEX_FROM_START = "第#筆";
...
Blockly.Msg.PROCEDURES_CALL_TOOLTIP = "回傳函式名稱讓其他功能可以呼叫";
...
Blockly.Msg.TEXT_TO_HEX = " 轉換成 ";
Blockly.Msg.TEXT_TO_HEX_TOOLTIP = "使用指定的進位方式轉換成字串";
...
Blockly.Msg.ARD_ANALOGWRITE = "類比輸出腳位#";
Blockly.Msg.ARD_ANALOGWRITE_MSG = "類比輸出腳位# %1 為 %2";
Blockly.Msg.ARD_ANALOGWRITE_TIP = "輸出類比值 0 到 255 到指定腳位";
Blockly.Msg.ARD_ANALOG_PIN = "類比腳位";
Blockly.Msg.ARD_DEFINE = "定義";
Blockly.Msg.ARD_DIGITAL = "數位 腳位#";
...
Blockly.Msg.ARD_DIGITALWRITE = "數位輸出 腳位#";
Blockly.Msg.ARD_DIGITALWRITE_MSG = "數位輸出腳位# %1 為 %2";
Blockly.Msg.ARD_DIGITALWRITE_TIP = "輸出數位值高(High)或低(Low)到指定腳位";
Blockly.Msg.ARD_FUN_RUN_LOOP = "迴圈程序: ";
Blockly.Msg.ARD_FUN_RUN_SETUP = "設定程序: ";
Blockly.Msg.ARD_FUN_RUN_TIP = "定義 Arduino 草稿碼的 setup() 和 loop() 程序";
Blockly.Msg.ARD_HIGH = "高";
Blockly.Msg.ARD_HIGHLOW_TIP = "設定腳位的邏輯狀態是高(High)或低(Low)";
Blockly.Msg.ARD_I2CREAD = "I2C 腳位#";
Blockly.Msg.ARD_I2CREAD_MSG = "I2C的SDA或SLC腳位";
Blockly.Msg.ARD_I2CREAD_TIP = "選擇I2C的SDA或SLC腳位";
Blockly.Msg.ARD_INPUT_PULLUP = " 設為輸入(上拉電阻)";
Blockly.Msg.ARD_INPUT_PULLUP_MSG = "啟用 %1 號腳位的上拉電阻";
Blockly.Msg.ARD_INPUT_PULLUP_TIP = "啟用指定輸入腳位的上拉電阻";
Blockly.Msg.ARD_LOW = "低";
Blockly.Msg.ARD_MAP = "對應";
Blockly.Msg.ARD_MAP_TIP = "重新對應 [0-1024]範圍值 到[0-其他範圍]的值";
Blockly.Msg.ARD_MAP_VAL = "數值範圍到 [ 0 - ";
Blockly.Msg.ARD_MAP_X_TIP = "重新對應 [x - y]範圍值 到[x'- y']的值";
Blockly.Msg.ARD_NOTE = "音符";
Blockly.Msg.ARD_NOTONE = "關閉音調 腳位#";
Blockly.Msg.ARD_NOTONE_PIN = "沒有音調 腳位#";
Blockly.Msg.ARD_NOTONE_PIN_TIP = "停止在選擇的腳位播放音調";
Blockly.Msg.ARD_NOTONE_TIP = "在選擇的腳位關閉音調";
Blockly.Msg.ARD_PIN = "腳位";
Blockly.Msg.ARD_PIN_WARN1 = "腳位 %1 作為 %2 的腳位 %3. 已經被用在 %4.";
...
Blockly.Msg.ARD_PWM_PIN = "PWM腳位";
Blockly.Msg.ARD_SETTONE = "播放音調 腳位#";
Blockly.Msg.ARD_SET_INPUT = "設為輸入";
Blockly.Msg.ARD_SET_INPUT_TIP = "設數位腳位為輸入";
Blockly.Msg.ARD_SET_OUTPUT = "設為輸出";
Blockly.Msg.ARD_SET_OUTPUT_TIP = "設數位腳位為輸出";
Blockly.Msg.ARD_SPI_PIN = "SPI腳位";
Blockly.Msg.ARD_TEMPO = "節奏";
Blockly.Msg.ARD_TIME_DELAY = "等待";
Blockly.Msg.ARD_TIME_DELAY_MICROS = "微秒";
Blockly.Msg.ARD_TIME_DELAY_MICRO_TIP = "等待設定時間, 單位是微秒microseconds";
Blockly.Msg.ARD_TIME_DELAY_TIP = "等待設定時間, 單位是毫秒milliseconds";
Blockly.Msg.ARD_TIME_INF = "永遠等待 (直到程式結束)";
Blockly.Msg.ARD_TIME_INF_TIP = "等待直到程式結束執行";
Blockly.Msg.ARD_TIME_MICROS = "執行經過的時間(微秒)";
Blockly.Msg.ARD_TIME_MICROS_TIP = "傳回Arduino開發板執行目前程式經過的時間, 單位是微秒microseconds";
Blockly.Msg.ARD_TIME_MILLIS = "執行經過的時間(毫秒)";
Blockly.Msg.ARD_TIME_MILLIS_TIP = "傳回Arduino開發板執行目前程式經過的時間, 單位是毫秒milliseconds";
Blockly.Msg.ARD_TIME_MS = "毫秒";
Blockly.Msg.ARD_TIME_REPEAT = "重複執行";
Blockly.Msg.ARD_TIME_S = "秒";
Blockly.Msg.ARD_TONE = "音調";
...
Blockly.Msg.ARD_TONE_WARNING = "頻率必須在範圍 31 - 4987";
Blockly.Msg.ARD_TYPE_ARRAY = "陣列";
Blockly.Msg.ARD_TYPE_BOOL = "布林";
Blockly.Msg.ARD_TYPE_BYTE = "位元組";
Blockly.Msg.ARD_TYPE_CHAR = "字元";
Blockly.Msg.ARD_TYPE_CHILDBLOCKMISSING = "子積木遺失";
Blockly.Msg.ARD_TYPE_DECIMAL = "浮點數";
Blockly.Msg.ARD_TYPE_FUNCTION = "函式";
Blockly.Msg.ARD_TYPE_LONG = "長整數";
Blockly.Msg.ARD_TYPE_NULL = "空值";
Blockly.Msg.ARD_TYPE_NUMBER = "整數";
Blockly.Msg.ARD_TYPE_SHORT = "短整數";
Blockly.Msg.ARD_TYPE_STRING = "字串";
Blockly.Msg.ARD_TYPE_TEXT = "文字";
Blockly.Msg.ARD_TYPE_UNDEF = "沒有定義";
Blockly.Msg.ARD_TYPE_UNSIGNED_LONG = "無號長整數";
Blockly.Msg.ARD_VAR_AS = "型態";
Blockly.Msg.ARD_VAR_AS_TIP = "賦值為指定的型態";
Blockly.Msg.ARD_WRITE_TO = "為";
Blockly.Msg.ARRAY_ARRAY = "陣列";
Blockly.Msg.ARRAY_CONTENU = "內容";
Blockly.Msg.ARRAY_CONTIENT = "以";
Blockly.Msg.ARRAY_CREATE = "定義 ";
Blockly.Msg.ARRAY_CREATE_EMPTY_TITLE = "建立空陣列";
Blockly.Msg.ARRAY_CREATE_WITH = "建立陣列使用";
Blockly.Msg.ARRAY_CREATE_WITH_CONTAINER_TITLE_ADD = "陣列";
Blockly.Msg.ARRAY_CREATE_WITH_CONTAINER_TOOLTIP = "新增、刪除或移動項目來設定陣列積木";
Blockly.Msg.ARRAY_CREATE_WITH_HELPURL = "";
Blockly.Msg.ARRAY_CREATE_WITH_INPUT_WITH = "陣列";
Blockly.Msg.ARRAY_CREATE_WITH_ITEM_TITLE = "項目";
Blockly.Msg.ARRAY_CREATE_WITH_ITEM_TOOLTIP = "新增項目至陣列中";
Blockly.Msg.ARRAY_CREATE_WITH_TOOLTIP = "使用任意數量的項目來建立陣列。";
Blockly.Msg.ARRAY_DECLARE_NAME = "建立陣列";
Blockly.Msg.ARRAY_DECLARE_SIZE = "項目個數";
Blockly.Msg.ARRAY_DECLARE_TOOLTIP = "以指定型態與特定項目建立陣列";
Blockly.Msg.ARRAY_DECLARE_TYPE = "型態";
Blockly.Msg.ARRAY_DIM = "維度";
Blockly.Msg.ARRAY_GETINDEX_AT = "取得索引";
Blockly.Msg.ARRAY_GETINDEX_AT1 = "取得索引";
Blockly.Msg.ARRAY_GETINDEX_AT2 = "索引";
Blockly.Msg.ARRAY_GETINDEX_HELPURL = "";
Blockly.Msg.ARRAY_GETINDEX_ITEM = "從陣列";
Blockly.Msg.ARRAY_GETINDEX_TOOLTIP = "";
Blockly.Msg.ARRAY_GETINDEX_TOOLTIP1 = "取得存在列表或陣列中的值";
Blockly.Msg.ARRAY_GETINDEX_TOOLTIP2 = "以選定的型態建立列表或陣列";
Blockly.Msg.ARRAY_GETINDEX_TOOLTIP3 = "設定列表或陣列中的值";
Blockly.Msg.ARRAY_INDEX = "索引";
Blockly.Msg.ARRAY_LIST = "列表";
Blockly.Msg.ARRAY_MAP = "陣列對應";
Blockly.Msg.ARRAY_MAP_FROM = " 來源 ";
Blockly.Msg.ARRAY_MAP_SIZE = " 大小 ";
Blockly.Msg.ARRAY_MAP_TO = " 目的 ";
Blockly.Msg.ARRAY_MAP_TOOLTIP = "陣列對應";
Blockly.Msg.ARRAY_MODIFY_INDICE = "設定陣列項目";
Blockly.Msg.ARRAY_MODIFY_NAME = "於陣列";
Blockly.Msg.ARRAY_MODIFY_TOOLTIP = "為陣列的項目設定值";
Blockly.Msg.ARRAY_MODIFY_VALUE = "值";
Blockly.Msg.ARRAY_SET_WITH = "建立陣列以";
Blockly.Msg.ARRAY_TAB_CREATE = "建立陣列  %1 的項目積木";
Blockly.Msg.ARRAY_TAB_CREATE_FIX = "建立積木 '設定陣列項目 %1 為'";
Blockly.Msg.ARRAY_TAILLE = "陣列大小";
Blockly.Msg.ARRAY_fixe = "變更值於陣列";
Blockly.Msg.NEW_INSTANCE = "生成物件...";
Blockly.Msg.NEW_INSTANCE_TITLE = "生成物件名稱:";
Blockly.Msg.RENAME_INSTANCE = "重新命名物件...";
Blockly.Msg.RENAME_INSTANCE_TITLE = "重新命名 '%1' 物件為:";
Blockly.Msg.TEXT_CHAR_HELPURL = "";
Blockly.Msg.TEXT_CHAR_TOOLTIP = "";
Blockly.Msg.VARIABLES_AS = "為";
Blockly.Msg.VARIABLES_DECLARE = "宣告全域變數 %1, 型態為 %2, %3 常數";
Blockly.Msg.VARIABLES_DECLARE_TOOLTIP = "宣告全域變數";
Blockly.Msg.VARIABLES_GET_ITEM = "i";
Blockly.Msg.VARIABLES_INIT = "宣告全域變數 %1, 型態為 %2, 初值為 %3, %4 常數";
Blockly.Msg.VARIABLES_INIT_NOT_IN_SETUP_WARNING = "警告： 此積木僅可用於 SETUP 設定積木內。";
Blockly.Msg.VARIABLES_INIT_REDEFINED_WARNING = "警告: 變數 %1 不可重複宣告.";
Blockly.Msg.VARIABLES_INIT_TOOLTIP = "賦值此變數的初值等於輸入值";
...
Blockly.Msg.VARIABLES_WARN_TEXT = "變數 %1 已經設定為 %2 型態, 但這個積木輸出為 %3 型態！";
Blockly.Msg._AT = "新值";
